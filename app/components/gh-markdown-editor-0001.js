// Copied from Ghost Admin client https://raw.githubusercontent.com/TryGhost/Ghost-Admin/master/app/components/gh-markdown-editor.js
...
export default Component.extend({
    ...
    init() {
        ...
        let shortcuts = {};
        shortcuts[`ctrl+shift+i`] = {action: 'openImageFileDialog'};
